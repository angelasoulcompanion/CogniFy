...
@dataclass
class TableInfo(SerializableMixin):
    ...
    # to_dict() is auto-generated by SerializableMixin


@dataclass
class SyncConfig(SerializableMixin):
...
@dataclass
class DatabaseConnection(SerializableMixin):
    """Database connection entity"""

    _exclude_fields: ClassVar[Set[str]] = {"password_encrypted"}
